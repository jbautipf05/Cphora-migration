...
| EX-07 | H-003 | Al **crear un lead**, Demo6 genera 6 seguimientos automáticos (`generateLeadSeguimientos`); React no genera ninguno. Fuera del alcance de H-003 (campos/validación). | ⏳ Pendiente (no está en los 7 P0). |
