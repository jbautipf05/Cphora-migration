...
export const ORDERS = [
  { id: 'PED-1245', quoteId: 'COT-2002', customerId: 'C-004', clientName: 'Carmiña Chapman', total: 7340000, paid: 60, tiempo: 60, orderDate: '2026-03-30', estado: 'produccion', area: 'Tapicería', asesor: 'Alexander Vivas', tipo: 'produccion', docType: 'factura', deliveryAddress: 'Centro Histórico, Cl 35 # 3-27', verified: true, productId: 'p6', qty: 1 },
...
export const EMPLOYEES = [
  { id: 'E-001', name: 'Alexander Vivas', role: 'Gerente Comercial', area: 'Comercial', hiredAt: '2021-05-10', estado: 'activo', salario: 6500000, email: 'alex@castor.co' },
  { id: 'E-002', name: 'Thalia Cifuentes', role: 'Asesora Comercial', area: 'Comercial', hiredAt: '2023-02-14', estado: 'activo', salario: 3500000, email: 'thalia@castor.co' },
  { id: 'E-003', name: 'Nelson Díaz', role: 'Jefe de Taller', area: 'Ebanistería', hiredAt: '2020-08-01', estado: 'activo', salario: 4200000, email: 'nelson@castor.co' },
  { id: 'E-004', name: 'Yolanda Reyes', role: 'Contadora', area: 'Administrativo', hiredAt: '2022-03-15', estado: 'activo', salario: 4800000, email: 'yolanda@castor.co' },
  ...
  { id: 'E-006', name: 'Luisa Ortega', role: 'Coord. Bodega Ctg', area: 'Logística', hiredAt: '2023-06-01', estado: 'activo', salario: 2600000, email: 'luisa@castor.co' },
  { id: 'E-007', name: 'Héctor Pulido', role: 'Coord. Bodega Volcanes', area: 'Logística', hiredAt: '2023-09-12', estado: 'activo', salario: 2600000, email: 'hector@castor.co' },
];
