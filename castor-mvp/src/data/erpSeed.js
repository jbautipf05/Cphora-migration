...
export const ORDERS = [
  { id: 'PED-1245', quoteId: 'COT-2002', customerId: 'C-004', clientName: 'Carmiña Chapman', total: 8500000, paid: 60, tiempo: 60, orderDate: '2026-03-30', estado: 'produccion', area: 'Tapicería', asesor: 'Alexander Vivas', tipo: 'produccion', docType: 'factura', deliveryAddress: 'Centro Histórico, Cl 35 # 3-27', verified: true, productId: 'p6', qty: 1 },
